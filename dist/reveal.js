...
!(function (e, t) {
  ...
  class p {
    ...
    constructor(e) {
      ((this.Reveal = e),
        ...
        (this.ensureMobileMediaPlaying =
          this.ensureMobileMediaPlaying.bind(this)),
    ...
    renderMediaPlayButton() {
      ((this.mediaPlayButton = document.createElement("button")),
        (this.mediaPlayButton.className =
          "r-overlay-button r-media-play-button"),
    ...
    load(e, i = {}) {
      const s = this.Reveal.getConfig().display;
      if (s.includes("!important")) {
        const t = s.replace(/\s*!important\s*$/, "").trim();
    ...
    ensureMobileMediaPlaying(e) {
      ...
      "function" == typeof t.getVideoPlaybackQuality &&
        setTimeout(() => {
          const e = !1 === t.paused,
            i = t.getVideoPlaybackQuality().totalVideoFrames;
          e && 0 === i && (t.load(), t.play());
        }, 1e3);
    }
        ...
        t
          ...
          .catch((t) => {
            if ("NotAllowedError" === t.name)
              if (((this.allowedToPlayAudio = !1), "VIDEO" === e.tagName)) {
              ...
              } else "AUDIO" === e.tagName && this.onAudioPlaybackNotAllowed(e);
          });
    }
    ...
    showPlayOrUnmuteButton() {
      ...
      let i = "Play media";
      (this.failedMutedVideoPlaybackTargets.size > 0
        ? (i = "Play video")
        : t > 0
          ? (i = "Unmute video")
          : e > 0 && (i = "Play audio"),
        (this.mediaPlayButton.textContent = i),
    ...
    onMutedVideoPlaybackNotAllowed(e) {
      (this.failedMutedVideoPlaybackTargets.add(e),
  ...
  function $(n, o) {
    ...
    function ke(t) {
      const s = { ...R };
      if (("object" == typeof t && e(R, t), !1 === l.isReady())) return;
      const a = _.wrapper.querySelectorAll(m).length;
      (_.wrapper.classList.remove(s.transition),
        _.wrapper.classList.add(R.transition),
        _.wrapper.setAttribute("data-transition-speed", R.transitionSpeed),
        ...
        R.shuffle && Je(),
        i(_.wrapper, "embedded", R.embedded),
        i(_.wrapper, "rtl", R.rtl),
        i(_.wrapper, "center", R.center),
        !1 === R.pause && je(),
        ae.reset(),
        S && (S.destroy(), (S = null)),
        a > 1 &&
        ...
        "default" !== R.navigationMode
          ? _.wrapper.setAttribute("data-navigation-mode", R.navigationMode)
    ...
    function Le() {
      (window.addEventListener("resize", kt, !1),
        ...
        R.keyboard && ce.bind(),
        R.progress && ge.bind(),
        R.respondToHashChanges && he.bind(),
        ue.bind(),
        fe.bind(),
        _.slides.addEventListener("click", Rt, !1),
        _.slides.addEventListener("transitionend", At, !1),
        _.pauseOverlay.addEventListener("click", je, !1),
    ...
    function Ce() {
      (ye.unbind(),
        ...
        _.slides.removeEventListener("transitionend", At, !1),
        _.pauseOverlay.removeEventListener("click", je, !1));
    }
    function Pe(e, t, i) {
    ...
    function Me({ target: t = _.wrapper, type: i, data: s, bubbles: a = !0 }) {
      ...
      if (_.wrapper && !oe.isActive()) {
        ...
        if (!R.disableLayout) {
          ...
          (He(R.width, R.height),
            ...
            (X = Math.max(X, R.minScale)),
            (X = Math.min(X, R.maxScale)),
            1 === X || re.isActive()
              ? ((_.slides.style.zoom = ""),
                (_.slides.style.left = ""),
                (_.slides.style.top = ""),
              ...
              : ((_.slides.style.zoom = ""),
                ...
                Te({ layout: "translate(-50%, -50%) scale(" + X + ")" })));
          ...
          s !== X &&
            Me({ type: "resize", data: { oldScale: s, scale: X, size: i } });
        }
        (!(function () {
          if (
            _.wrapper &&
    ...
    function Ke(e) {
      "boolean" == typeof e ? (e ? We() : je()) : $e() ? je() : We();
    }
    function $e() {
    ...
    function Xe(e, i, s, a) {
      ...
      e: for (let e = 0, t = $.length; e < t; e++) {
        ...
        (_.viewport.classList.add($[e]), Me({ type: $[e] }));
      }
      for (; o.length; ) _.viewport.classList.remove(o.pop());
      (u && (te.afterSlideChanged(), Ne(a)),
    ...
    function _e() {
      (Ce(),
        ...
        ne.create(),
        he.writeURL(),
        !0 === R.sortFragmentsOnSync && le.sortAll(),
        ue.update(),
        ge.update(),
        et(),
        be.update(),
    ...
    function Ge(e, i) {
      ...
      if (a) {
        ...
        (e.classList.add("present"),
          ...
          t || Me({ target: e, type: "visible", bubbles: !1 }));
    ...
    function et() {
      ...
      if (a && void 0 !== c) {
        const n = de.isActive();
        let r = n ? 10 : R.viewDistance;
        (u && (r = n ? 6 : R.mobileViewDistance),
      ...
      if ((gt(), v && !1 !== R.autoSlide)) {
        ...
        (i
          ...
          !G ||
            ...
            $e() ||
            de.isActive() ||
            (Ue() && !le.availableRoutes().next && !0 !== R.loop) ||
            ((Q = setTimeout(() => {
    ...
    function vt() {
      G &&
        !ee &&
        ((ee = !0),
        Me({ type: "autoslidepaused" }),
        clearTimeout(Q),
        S && S.setPlaying(!1));
    }
    function pt() {
      G && ee && ((ee = !1), Me({ type: "autoslideresumed" }), ut());
    }
    function mt({ skipFragments: e = !1 } = {}) {
      ...
      R.rtl
        ? (de.isActive() || e || !1 === le.next()) &&
          tt().left &&
          Xe(c + 1, "grid" === R.navigationMode ? h : void 0)
      ...
      if (e || !1 === le.prev())
        if (tt().up) yt({ skipFragments: e });
          ...
          if (
            ...
            Xe(c - 1, e);
          } else R.rtl ? ft({ skipFragments: e }) : mt({ skipFragments: e });
        }
    }
    ...
    function Pt(e) {
      Ue() && !1 === R.loop ? (Xe(0, 0), pt()) : ee ? pt() : vt();
    }
    const xt = {
      VERSION: K,
      initialize: function (e) {
        ...
        return (
          ...
          pe.load(R.plugins, R.dependencies).then(we),
      ...
      toggleAutoSlide: function (e) {
        "boolean" == typeof e ? (e ? pt() : vt()) : ee ? pt() : vt();
      },
      ...
      addEventListeners: Le,
      removeEventListeners: Ce,
      dispatchEvent: Me,
      getState: ht,
      setState: function (e) {
        if ("object" == typeof e) {
      ...
      setCurrentScrollPage: function (e, t, i) {
        ...
        ((g = v),
          (v = e),
          v && g && R.autoAnimate && Ye(g, v, s, h) && ae.run(g, v),
          a &&
            (te.afterSlideChanged(),
            g &&
